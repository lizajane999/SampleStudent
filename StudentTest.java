...
public class StudentTest {
   ...
   */
   @Test public void constructorTest3() {
      ...
      Assert.assertEquals("getGPA returns incorrect GPA", 
          s.getGPA(), 4.5, 0.0f);
   ...
   */
   @Test public void defaultGPATest() {
      ...
      Assert.assertEquals("GPA is not set to the correct default value.", 
          s.getGPA(), -1.0, 0.0f);
   ...
   */
   @Test public void toStringTest2() {
      ...
      int sID = s.getID();
      double sGPA = s.getGPA();
      Assert.assertEquals("toString return not correct if GPA not set.",
   ...
   */
   @Test public void setNameTest() {
      ...
      s.setName(newName);
      Assert.assertTrue("setName problem, getName returns incorrect name",
   ...
   */
   @Test public void setGPATest() {
      ...
      double newGPA = 3.45;
      s.setGPA(newGPA);
      Assert.assertTrue("setGPA problem, getGPA after returns incorrect value", 
          s.getGPA() == newGPA);   
   }
   ...
   */
   @Test public void setIDTest() {
      ...
      int newID = 277;
      s.setID(newID);
      Assert.assertTrue("setID problem, getID after returns incorrect value",
          s.getID() == newID);   
   }
